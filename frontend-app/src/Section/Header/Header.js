            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0 -mb-2 navbar-Daten">
              ...
              <li className="nav-item">
                <Link to={'/shop/warenkorb'} className="nav-link active">
                  <span className="icon"><FaShoppingCart /></span> Warenkorb <span className='warenkorb-anzahl'>{anzahl}</span>
                </Link>
              </li>
              <li className="nav-item">
                <Link to={'/shop/kundendaten'} className="nav-link active">
                  <span className="icon"><FaUser /></span> Meine Daten
                </Link>
              </li>
              <li className="nav-item">
                <Link to={'/shop/KundenProdukte'} className="nav-link active">
                  <span className="icon"><FaShoppingBag /></span> Meine Bestellungen
                </Link>
              </li>
              <li className="nav-item dropdown">
                <a className="nav-link dropdown-toggle dropdown" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  Kategorien
                </a>
                <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><Link className="dropdown-item" to={'kleidung'}>Kleidung</Link></li>
                  <li><Link className="dropdown-item" to={'geraete'}>Geräte</Link></li>
                  <li><Link className="dropdown-item" to={'moebel'}>Möbel</Link></li>
                </ul>
              </li>
              <li className="nav-item">
